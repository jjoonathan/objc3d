...
/************************************/ #pragma mark Setters /************************************/
O3Space3& O3Space3::SetSuperspace(O3Space3* supers) {
...
O3Space3&	O3Space3::Set(const O3Mat4x4d& mat) {
	Modified();
...
O3Space3& O3Space3::Set(const O3Transformation3& trans) {
	Modified();
...
O3Space3& O3Space3::Set(const O3Space3& other) {
	Modified();
...
O3Space3& O3Space3::Set(const O3Translation3& trans, const O3Rotation3& rot, const O3Scale3& scale) {
	Modified();
	mFromSuperspace.Set(trans);
	mFromSuperspace+=rot;
...
void O3Space3::UpdateRootspaceTransform() const { //I forsee looped spaces. mmm, fun.
...
const O3Mat4x4d& O3Space3::MatrixFromSuper() const {
	return mFromSuperspace.O3Mat();
}

const O3Mat4x4d& O3Space3::MatrixFromRoot() const {
	UpdateRootspaceTransform();
	return mFromRootspace.O3Mat();
}

O3Mat4x4d O3Space3::MatrixToSpace(const O3Space3* other) const {
	if (other->IsSame(mSuperspace))
		return mFromSuperspace.InverseMatrix();
	return other->MatrixFromRoot()*MatrixToRoot();
}

const O3Mat4x4d& O3Space3::MatrixToRoot() const {
	UpdateRootspaceTransform();
	return mFromRootspace.InverseMatrix();
}

const O3Mat4x4d& O3Space3::MatrixToSuper() const {
	return mFromSuperspace.InverseMatrix();
}

O3Vec3d O3Space3::VectorToSpace(const O3Space3* other, O3Vec3d oldvec) const {
	const O3Mat4x4d& mat = MatrixToSpace(other);
	return O3Vec3d(mat*O3Vec4d(oldvec));
}

O3Vec4d O3Space3::VectorToSpace(const O3Space3* other, O3Vec4d oldvec) const {
	const O3Mat4x4d& mat = MatrixToSpace(other);
	return mat*oldvec;	
}

O3Vec3d O3Space3::VectorToRoot(O3Vec3d oldvec) const {
	const O3Mat4x4d& mat = MatrixToRoot();
	O3Vec4d to_mult = O3Vec4d(oldvec.X(), oldvec.Y(), oldvec.Z(), 1.);
	return O3Vec3d(mat*to_mult);
}

O3Vec4d O3Space3::VectorToRoot(O3Vec4d oldvec) const {
	const O3Mat4x4d& mat = MatrixToRoot();
	return mat*oldvec;	
}

O3Vec3d O3Space3::VectorFromRoot(O3Vec3d oldvec) const {
	const O3Mat4x4d& mat = MatrixFromRoot();
	O3Vec4d to_mult = O3Vec4d(oldvec.X(), oldvec.Y(), oldvec.Z(), 1.);
	return O3Vec3d(mat*to_mult);
}

O3Vec4d O3Space3::VectorFromRoot(O3Vec4d oldvec) const {
	const O3Mat4x4d& mat = MatrixFromRoot();
	return mat*oldvec;	
}

/************************************/ #pragma mark Operators /************************************/
O3Space3& O3Space3::operator=(const O3Space3& other) {
...
O3Space3& O3Space3::operator+=(const O3Scale3& scale) {
	Modified();
	mFromSuperspace += scale;
	DidChange();
	return *this;
...
O3Space3& O3Space3::operator+=(const O3Rotation3& rot) {
	Modified();
	mFromSuperspace += rot;
	DidChange();
	return *this;
...
O3Space3& O3Space3::operator+=(const O3Translation3& trans) {
	Modified();
...
O3Space3& O3Space3::operator+=(const O3Transformation3& trans) {
	Modified();
	mFromSuperspace += trans;
	DidChange();
	return *this;
...
O3Space3& O3Space3::operator+=(const O3Mat4x4d& mat) {
	Modified();
	mFromSuperspace += mat;
	DidChange();
	return *this;
