...
DefType(O3Int32Type,O3VecStructInt32Element,@"i32");\
DefType(O3Int64Type,O3VecStructInt64Element,@"i64");\
DefType(O3UInt8Type,O3VecStructUInt8Element,@"ui8");\
DefType(O3UInt16Type,O3VecStructUInt16Element,@"ui16");\
DefType(O3UInt32Type,O3VecStructUInt32Element,@"ui32");\
DefType(O3UInt64Type,O3VecStructUInt64Element,@"ui64");
