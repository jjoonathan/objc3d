...
+ (void)load {
	...
	gO3Vec3rType = [O3VecStructType vecStructTypeWithElementType:rtype                     specificType:O3VecStructVec count:3 name:@"vec3r"];
	gO3Vec3fType = [O3VecStructType vecStructTypeWithElementType:O3VecStructFloatElement   specificType:O3VecStructVec count:3 name:@"vec3f"];
	gO3Vec3dType = [O3VecStructType vecStructTypeWithElementType:O3VecStructDoubleElement  specificType:O3VecStructVec count:3 name:@"vec3d"];
	gO3Vec4rType = [O3VecStructType vecStructTypeWithElementType:rtype                     specificType:O3VecStructVec count:4 name:@"vec4r"];
	gO3Vec4fType = [O3VecStructType vecStructTypeWithElementType:O3VecStructFloatElement   specificType:O3VecStructVec count:4 name:@"vec4f"];
	gO3Vec4dType = [O3VecStructType vecStructTypeWithElementType:O3VecStructDoubleElement  specificType:O3VecStructVec count:4 name:@"vec4d"];
	gO3Rot3d     = [O3VecStructType vecStructTypeWithElementType:O3VecStructDoubleElement  specificType:O3VecStructRotation count:3 name:@"rot3d"];
	gO3Point3d   = [O3VecStructType vecStructTypeWithElementType:O3VecStructDoubleElement  specificType:O3VecStructPoint count:3 name:@"point3d"];
	gO3Scale3d   = [O3VecStructType vecStructTypeWithElementType:O3VecStructDoubleElement  specificType:O3VecStructScale count:3 name:@"scale3d"];
	gO3Index3x8  = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt8Element   specificType:O3VecStructIndex count:3 name:@"scale3x8"];
	gO3Index3x16 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt16Element  specificType:O3VecStructIndex count:3 name:@"scale3x16"];
	gO3Index3x32 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt32Element  specificType:O3VecStructIndex count:3 name:@"scale3x32"];
	gO3Index3x64 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt64Element  specificType:O3VecStructIndex count:3 name:@"scale3x64"];
	gO3Index4x8  = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt8Element   specificType:O3VecStructIndex count:4 name:@"scale4x8"];
	gO3Index4x16 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt16Element  specificType:O3VecStructIndex count:4 name:@"scale4x16"];
	gO3Index4x32 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt32Element  specificType:O3VecStructIndex count:4 name:@"scale4x32"];
	gO3Index4x64 = [O3VecStructType vecStructTypeWithElementType:O3VecStructUInt64Element  specificType:O3VecStructIndex count:4 name:@"scale4x64"];
}
