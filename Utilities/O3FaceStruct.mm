...
- (O3FaceStruct*)initWithV1:(O3Point3f)v1 v2:(O3Point3f)v2 v3:(O3Point3f)v3 {
	O3Triangle3x3f* tri = (O3Triangle3x3f*)malloc(sizeof(O3Triangle3x3f));
	tri->v1 = v1;
	tri->v2 = v2;
	tri->v3 = v3;
	return (O3FaceStruct*)[super initWithBytesNoCopy:tri type:O3Triangle3x3fType() freeWhenDone:YES];
}
...
@interface O3TriFaceStructType : O3VecStructType {}
@end
